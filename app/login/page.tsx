    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 32 }}>
          <div style={{
            width: 40, height: 40, borderRadius: 10, background: '#185FA5',
        ...
        <form onSubmit={handleLogin}>
          ...
          {error && (
            <div style={{
              background: '#1e0f0f', border: '0.5px solid #5a1f1f', borderRadius: 8,
              padding: '10px 13px', fontSize: 12, color: '#f09595',
          ...
          <div style={{ marginBottom: 18 }}>
            <label style={{ display: 'block', fontSize: 11, fontWeight: 600, color: '#a0a09a', marginBottom: 7, textTransform: 'uppercase', letterSpacing: '.06em' }}>
              User ID
            </label>
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                style={{
                  ...
                  background: '#0d0e17', border: '0.5px solid #2a2a35',
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                style={{
                  width: '100%', padding: '11px 42px 11px 38px', fontSize: 14,
                  background: '#0d0e17', border: '0.5px solid #2a2a35',
                  borderRadius: 8, color: '#e8e8e4', outline: 'none',
                  boxSizing: 'border-box', transition: 'border-color .15s',
                }}
        ...
        <div style={{ marginTop: 28, textAlign: 'center', fontSize: 11, color: '#3a3a45' }}>
