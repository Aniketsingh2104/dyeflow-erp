// Run from C:\dyeflow-react: node fix-first-process-full.js
const fs = require('fs')
...
fs.writeFileSync(path.join('app', 'first-process-batch', 'page.tsx'), newPage, 'utf8')
console.log('✓ First Process Batch page rewritten with filter row, column hide/show, and column resize')
